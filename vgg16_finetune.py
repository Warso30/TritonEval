...
#     """Prepare ImageNet-style training and validation dataloaders."""
...
def build_model(num_classes):
    ...
    model = models.vgg16(weights=models.VGG16_Weights.IMAGENET1K_V1)  # VGG16 with ImageNet-1K weights :contentReference[oaicite:3]{index=3}
